...
<form method="post" action="index.php?m=admin&a=replyblog" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 博文回收站</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
      ...
      <?php foreach($info as $val) :?>
        <tr>
         ...
         <td><?=$val['title'];?></td>
          ...
          <a href="index.php?m=admin&a=replyblog&id=<?=$val['id'];?>" class="button border-red">恢复</a>
