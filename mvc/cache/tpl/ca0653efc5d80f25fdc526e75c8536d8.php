...
<form method="post" action="index.php?m=admin&a=delmessage" id="listform">
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      ...
      <?php foreach($info as $val) :?>
        <tr>
          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="iii[]" value="" />
           <?=$val['id'];?></td>
          <td><?=$val['author'];?></td>
         <td><?=$val['title'];?></td>
          <td><?=$val['content'];?></td>
         ...
         <a href="index.php?m=admin&a=delmessage&id=<?=$val['id'];?>" class="button border-red">放入回收站</a>
