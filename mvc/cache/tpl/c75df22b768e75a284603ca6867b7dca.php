...
<form method="post" action="index.php?m=admin&a=relieve" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder">用户回收站</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
        ...
        <tr>
         ...
         <td><?=$val['email'];?></td>
          ...
          <td><div class="button-group"> 
           ...
           <a href="index.php?m=admin&a=relieve&id=<?=$val['id'];?>" class="button border-red">解除锁定</a>
