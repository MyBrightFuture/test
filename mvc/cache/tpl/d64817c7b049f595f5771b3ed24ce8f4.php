...
<form method="post" action="index.php?m=admin&a=dodel" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 博文管理</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
        ...
        <tr>
         ...
         <td><?=$val['title'];?></td>
          ...
          <td><div class="button-group"> 
            ...
            <a href="index.php?m=admin&a=dodel&id=<?=$val['id'];?>" class="button border-red">删除</a>
