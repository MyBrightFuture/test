...
<article>
  <div class="l_box f_l">
    ...
    <div class="topnews">
      <h2>
        <span>
          <a href="https://www.yezismile.com/" target="_blank">返回首页&gt;&gt;</a>
         </span>
         <b>给博主</b>留言
      </h2>
      <?php if(!empty ($messinfo)): ?>
      <?php foreach($messinfo as $val) :?>
    <div class="blogs">
        <figure>
            <a href="https://www.yezismile.com/detail/457.html" title="<?=$messinfo[0]['title'];?>" target="_blank">
         ...
         <ul>
          ...
          <p class="autor">
            <span class="lm f_l"><a href="" target="_self">博主留言</a></span>
    ...
    &nbsp;
      ...
      <?php endif;?>
           <form action="index.php?m=article&a=domessage" method="post">
  <div>
 
  <textarea  class="ckeditor" id="TextAeal" name="content" ></textarea>
  </div>
  <div>
  ...
  <style type="text/css">
    ...
    .smile_news h3 { font-size: 14px; background: url(images/r_title_bg.jpg) repeat-x center }
    .smile_news h3 p { background: #fff; width: 70px }
    .smile_news h3 span { color: #65b020 }
    .smile_rank li { height: 25px; line-height: 25px; clear: both; padding-left: 5px; overflow: hidden; padding-left: 15px; background: url(images/li.jpg) no-repeat left center; }
    .smile_rank { margin: 10px 0 }
    .smile_rank li a { color: #333; }
    .smile_rank li:first-child a {display: block;}
    .gzwm .feedback { background: url(images/feedback.jpg) no-repeat scroll 0% 0% transparent; }
    .gzwm .feedback:hover { color: #000; background: url(images/feedback_hover.jpg ) no-repeat scroll 0% 0% transparent; }
    ...
    .contact_us a i{background-image:url(images/yz_icon011-2.png);background-size:50px auto;-webkit-background-size:50px auto;}
...
<script id="cy_cmt_num" src="js/plugins.list.count.js"></script>
<div class="blank"></div>
<div id="copright">
   <div id="tbox"> 
...
<!--<script src="js/95056bdbeefb4aafbec920f77beb47e2.js"></script>-->
