...
<form method="post" action="index.php?m=admin&a=delreply" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 评论管理</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
        ...
        <tr>
         ...
         <td><?=$val['title'];?></td>
          ...
          <td><div class="button-group"> 
           ...
           <a href="index.php?m=admin&a=delreply&id=<?=$val['id'];?>" class="button border-red">放入回收站</a>
