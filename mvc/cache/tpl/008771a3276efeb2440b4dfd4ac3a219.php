...
<form method="post" action="index.php?m=admin&a=reco_message" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 留言回收站</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
        ...
        <tr>
         ...
         <td><?=$val['title'];?></td>
          ...
          <td><div class="button-group"> 
           ...
           <a href="index.php?m=admin&a=reco_message&id=<?=$val['id'];?>" class="button border-red">恢复</a>
