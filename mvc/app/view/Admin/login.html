		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					...
					<!-- Start Sign In Form -->
					<form action="index.php?m=admin&a=dologin" method="post" class="fh5co-form animate-box" data-animate-effect="fadeIn">
						<h2>登录到后台管理中心</h2>
			...
			<div class="row" style="padding-top: 60px; clear: both;">
				<div class="col-md-12 text-center"><p><small>&copy; All Rights Reserved. <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">管理好自己，提醒自己要做些什么</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">积极主动</a></small></p></div>
			</div>
		</div>
